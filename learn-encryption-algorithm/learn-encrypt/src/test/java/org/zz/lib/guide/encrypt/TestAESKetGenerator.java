...
import org.zz.lib.guide.encrypt.algorithm.impl.AESKeyGenCipherEncryptImp;
 ...
 */
public class TestAESKetGenerator {
    public static final Logger logger = Logger.getLogger("TestAESKetGenerator");

    public static final String T_PLAINTEXT = "hello 世界";

    public static final String T_SALT = "12345678"; // 8,不固定
    public static final String T_KEY = "12345678f"; // 8,不固定

    @Test
    public void t1() throws Exception {
        logger.log(Level.INFO, "原始内容: {0}, 长度:{1}", new Object[]{T_PLAINTEXT, T_PLAINTEXT.length()});

        ICipherEncrypt<AESEnum> aesCipherEncryptImp = new AESKeyGenCipherEncryptImp();
        // 加密
