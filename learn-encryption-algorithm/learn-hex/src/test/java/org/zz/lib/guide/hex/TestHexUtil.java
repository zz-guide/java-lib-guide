package org.zz.lib.guide.hex;

import org.apache.commons.codec.binary.Hex;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import org.zz.lib.guide.hex.util.HexUtil;
import org.zz.lib.guide.hex.util.HexUtil2;
import org.zz.lib.guide.hex.util.HexUtil3;
...
public class TestHexUtil {
    ...
    public void testByteToHex() {
        ...
        String shaLowerStr4 = Hex.encodeHexString(TEST_BYTES);
        logger.log(Level.INFO, "Hex.encodeHexString: {0}", new Object[]{shaLowerStr4});
